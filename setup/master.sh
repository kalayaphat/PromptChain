...
outputfilepath=~/promptchain.out
...
bash -e configure-promptchain.sh $db_root_pass $db_admin_user $db_admin_pass
...
'promptchain_db_admin_user='$db_admin_user"\n"\
'promptchain_db_admin_pass='$db_admin_pass"\n\n"\
 >> $outputfilepath
