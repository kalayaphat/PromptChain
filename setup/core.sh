...
mv -f $INSTALLER_PATH/../promptchain-web $webServerActiveDirectory

cd $webServerActiveDirectory	# Changing current directory to web server's root directory

###
## INSTALLING & CONFIGURING Promptchain
###
app_directory=$webServerActiveDirectory'/promptchain-web'

# Configuring Promptchain
...
sudo sed -ie 's/promptchain-db/'$db_name'/g' $app_directory/primechain_functions/config.php
