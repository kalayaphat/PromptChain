            ...
            <div class="row">
                ...
                <div class='col-lg-5'>
                    <div class="alert alert-warning">
                            <p><strong><br/>
                            Promptchain says: </strong>Welcome to promptchain. Use S.A.M. (Smart Asset Manager to  create, view, re-issue and send blockchain assets. You can also create and accept offers. Use D.A.V.E. (Data Authentication & Verification Engine) to upload data to blockchain and to view uploaded data.
                    </div>
                </div>
